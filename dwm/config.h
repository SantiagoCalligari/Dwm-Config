...
static char selbordercolor[]             = "#ff1010";
...
static Key keys[] = {
	...
	{ 0,XF86MonBrightnessUp,   spawn,SHCMD("brightnessctl set +10% && kill -46 $(pidof dwmblocks) ") },
	{ 0,XF86MonBrightnessDown, spawn,SHCMD("brightnessctl set 10%- && kill -46 $(pidof dwmblocks)") },
	{ 0,XF86AudioLowerVolume,  spawn,SHCMD("pamixer -d 5 && kill -44 $(pidof dwmblocks) && volnoti-show \"$(pamixer --get-volume)\"") },
	{ 0,XF86AudioRaiseVolume,  spawn,SHCMD("pamixer -i 5 && kill -44 $(pidof dwmblocks) &&  volnoti-show \"$(pamixer --get-volume)\"") },
	TAGKEYS(                        XK_1,                                  0)
	TAGKEYS(                        XK_2,                                  1)
	TAGKEYS(                        XK_3,                                  2)
	TAGKEYS(                        XK_4,                                  3)
